...
import { demoAttendance, demoResults, demoAnnouncements, demoTimetable } from '../../data/demoData';
...
const StudentDashboard = () => {
 ...
 const avgAttendance = Math.round(
  Object.values(demoAttendance).reduce((sum, v) => sum + v.percentage, 0) / Object.keys(demoAttendance).length
 );
 ...
 const latestAnnouncements = demoAnnouncements.slice(0, 3);
 ...
 return (
  <div className="animate-fade-in" style={{ padding: '24px 28px' }}>
   ...
   <div style={{
    ...
    <StatCard title="Enrolled Subjects" value="5" subtitle="Current semester" icon={HiOutlineBookOpen} color="#B4D3D9" />
    <StatCard title="Pending Fees" value="₹0" subtitle="All clear!" icon={HiOutlineCurrencyRupee} color="#7EC8A0" />
